    ...
    <div class="footer-container">
        ...
        <div class="footer-column">
            ...
            <ul class="social-icons">
                <li><a href="https://instagram.com" target="_blank"><img src="<%=request.getContextPath()%>/images/instagram.svg" alt="Instagram"></a></li>
                <li><a href="https://tiktok.com" target="_blank"><img src="<%=request.getContextPath()%>/images/tiktok.svg" alt="TikTok"></a></li>
