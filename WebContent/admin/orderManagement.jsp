    ...
    <div class="admin-container">
        ...
        <div class="order-list">
            <c:choose>
                    ...
                    <c:forEach var="order" items="${orders}">
                        <div class="order-item">
                            <div class="order-header">
                                <span><strong>Ordine #${order.id}</strong> (Cliente ID: ${order.idAccount})</span>
                            ...
                            <div class="order-details">
                                <c:forEach var="detail" items="${order.details}">
                                    <div class="detail-line">
                                        <span>${detail.qta} x <c:out value="${detail.nomeProdotto}" /></span>
                ...
                <c:otherwise>
                    <p class="no-results">Nessun ordine trovato con i criteri selezionati.</p>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
